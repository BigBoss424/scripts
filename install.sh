...
vpnc desmume visualboyadvance-gtk audacity openshot cinelerra-cv recordmydesktop gtk-recordmydesktop 
vokoscreen fbreader retext ircd-hybrid irssi mediawiki-extensions zenmap lamp-server wireshark 
unetbootin brasero emacs24-lucid -y
